...
> 🇬🇧 A small Azure infrastructure project, built from scratch — network, virtual machines, storage, identity, monitoring & security.
> 🇩🇪 Ein kleines Azure-Infrastruktur-Projekt von Grund auf – Netzwerk, virtuelle Maschinen, Storage, Identity, Monitoring & Security.
...
📌 This is a **solo training project**, built as part of my Azure Weiterbildung at **DCI (Digital Career Institute)**.
📌 Dies ist ein **Solo-Trainingsprojekt**, entstanden im Rahmen meiner Azure-Weiterbildung am **DCI (Digital Career Institute)**.

---

## 🏢 The Scenario / Das Szenario
...
## 🔧 What I built / Was ich gebaut habe
...
> 💡 **Before / Vorher:** RDP port open to the entire internet (`Any`)
> 💡 **After / Nachher:** RDP port restricted to my own IP address
...
## 🏷️ Tagging Strategy / Tag-Strategie
